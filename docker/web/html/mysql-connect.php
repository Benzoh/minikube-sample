<?php
// getenvがちゃんと動いてないぽいけどね
// コンテナにログインして直接編集して、検証した結果接続できた。
try {
    ...
    $dbh = new pdo( "mysql:host=$mysql_host:3306;dbname=hoge",
                    getenv('MYSQL_USER'),
                    getenv('MYSQL_PASSWORD'),
                    array(PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION));
    // $dbh = new pdo( "mysql:host=mysql-service:3306;dbname=hoge",
    //                 "root",
    //                 "root",
    //                 array(PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION));
